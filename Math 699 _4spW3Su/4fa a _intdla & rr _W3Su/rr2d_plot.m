...
map = [
    0.0 0.0 0.0 % empty black 
    0.1 0.1 0.1 % E c1 light gray
    0.7 0.7 0.7 % N c2 the color very close to balck 
    0.4 0.4 0.4 % W color close to c1 dark gray
    1.0 1.0 1.0 % S color close to c2 white
      ];
